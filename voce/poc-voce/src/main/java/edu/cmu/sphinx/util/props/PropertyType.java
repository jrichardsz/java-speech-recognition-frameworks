...
public enum PropertyType{
	...
	COMPONENT("Component",String.class),COMPONENT_LIST("ComponentList",List.class),STRING("String",String.class),
	/**
	...
	RESOURCE("Resource"){
		...
		public boolean validateString(String obj) throws Exception{
			...
			// if it doesn't have a protocol spec add a "file:" to it, to make
			// it a URL
			if(obj.indexOf(':') == -1)
				obj="file:" + obj;
	...
	/**
	 * Calls to {@link #isValid} will check if an object is instance of the
	 * class. If null, {@link #validateString} will be used to validate the
	 * object.
	 */
