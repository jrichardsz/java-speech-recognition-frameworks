...
public class RecognitionTest
{
	public static void main(String[] argv)
	{
		...
		String voicePath = RecognitionTest.class.getResource("/org/jrichardsz/poc/voce/resources").getPath();
		String grammarPath = RecognitionTest.class.getResource("/org/jrichardsz/poc/voce/resources/gram").getPath();
